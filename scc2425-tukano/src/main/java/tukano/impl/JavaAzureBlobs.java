...
public class JavaAzureBlobs implements Blobs {
	
	private static Blobs instance;
	private static Logger Log = Logger.getLogger(JavaAzureBlobs.class.getName());
	...
	synchronized public static Blobs getInstance() {
		if( instance == null )
			instance = new JavaAzureBlobs();
		return instance;
	}
	
	private JavaAzureBlobs() {
